...
<div id="pcoded" class="pcoded">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="add-invoice.php">New Invoice</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
	...
	<form id="invoiceform" name="invoiceform">
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
			   <input name="invoicedate" class="form-control" type="date" required />
			</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<textarea rows="5" cols="5" name="public" class="form-control"
						placeholder="" required></textarea>
			</div>
