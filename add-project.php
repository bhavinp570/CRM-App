...
<div id="pcoded" class="pcoded">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="add-project.php">Add New Project</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
	...
	<form id="projectform" name="projectform">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<select name="name" id="select_name"  class="js-example-basic-single col-sm-12" required>
		...
		<div class="form-group row">
			...
			<label class="col-sm-2 col-form-label">Budgeted Hours</label>
			<div class="col-sm-4">
			   <input type="text" name="budgetedhours" class="form-control" required>
			</div>
	    </div>
	    <div class="form-group row">
			<label class="col-sm-2 col-form-label">Task Rate</label>
			<div class="col-sm-4">
				<input type="text" name="taskrate" class="form-control" required>
			</div>
		</div>
		<div class="form-group row">
