...
<body onload="recurringFetchdata()">
<!-- [ Pre-loader ] start -->
<div class="loader-bg">
        ...
        <div class="pcoded-main-container">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        <h4 class="m-b-10">Recurring Invoices</h4>
                                    </div>
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="reccur.php">Recurring Invoices</a>
                                        </li>                                      
                                    </ul>
                                </div>
                            </div>
			...
			<div class="card">
				<div class="card-header">
					...
					<span>Details of Recurring Invoices.</span>
				</div>
