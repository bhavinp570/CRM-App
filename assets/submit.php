...
case 2: // Start Inserting Clients data
		$sql = "insert into clients(ClientName, VatNumber, Email, Phone, Website, Street, AptSuit, City, StateProvince, PostalCode, Country, Date) values ('".$_POST['name']."','".$_POST['vatnumber']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['website']."','".$_POST['street']."','".$_POST['apt']."','".$_POST['city']."','".$_POST['state']."','".$_POST['postalcode']."','".$_POST['select']."','".date("Y-m-d")."')";
...
case 4: // Start Inserting Products data
		$sql = "insert into products(Product, Cost, Notes, Date) values ('".$_POST['product']."','".$_POST['cost']."','".$_POST['notes']."','".date("Y-m-d")."')";
		if(mysqli_query($con, $sql) or die(mysql_error())){
			echo "1";
		}else {
			echo "0";
...
case 6: // Start Inserting Invoices data
		$sql = "insert into invoices(ClientName, Email, Phone, Invoice, InvoiceDate, Po, DueDate, PartialDepo, Discount, Item, Description, UnitCost, Quantity, Currency, PrivateNotes, Terms, PublicNotes, Footer, Date) values ('".$_POST['name']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['invoice']."','".$_POST['invoicedate']."','".$_POST['po']."','".$_POST['duedate']."','".$_POST['partial']."','".$_POST['discount']."','".$_POST['item']."','".$_POST['description']."','".$_POST['unitcost']."','".$_POST['quantity']."','".$_POST['currency']."','".$_POST['private']."','".$_POST['terms']."','".$_POST['public']."','".$_POST['footer']."','".date("Y-m-d")."')";
		if(mysqli_query($con, $sql) or die(mysql_error())){
			echo "1";
		}else {
			echo "0";
...
case 8: // Start Inserting Payments data
		$sql = "insert into payments(ClientName, Invoice, Amount, PaymentType, PaymentDate, TransactionReference, PrivateNotes, Currency, ExchangeRate, ConvertedAmount, Date) values ('".$_POST['name']."','".$_POST['invoice']."','".$_POST['amount']."','".$_POST['paymenttype']."','".$_POST['paymentdate']."','".$_POST['transaction']."','".$_POST['currency']."','".$_POST['exchange']."','".$_POST['converted']."','".$_POST['private']."','".date("Y-m-d")."')";
		if(mysqli_query($con, $sql) or die(mysql_error())){
			echo "1";
		}else {
			echo "0";
...
case 10: // Start Inserting Recurringinvoices data
		$sql = "insert into recurringinvoices(ClientName, Email, Phone, Po, Frequency, AutoBill, StartDate, EndDate, DueDate, Currency, Discount, Item, Description, UnitCost, Quantity, PublicNotes, PrivateNotes, Terms, Footer, Date) values ('".$_POST['name']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['po']."','".$_POST['frequency']."','".$_POST['autobill']."','".$_POST['startdate']."','".$_POST['enddate']."','".$_POST['duedate']."','".$_POST['currency']."','".$_POST['discount']."','".$_POST['item']."','".$_POST['description']."','".$_POST['unitcost']."','".$_POST['quantity']."','".$_POST['publicnotes']."','".$_POST['privatenotes']."','".$_POST['terms']."','".$_POST['footer']."','".date("Y-m-d")."')";
		if(mysqli_query($con, $sql) or die(mysql_error())){
			echo "1";
		}else {
			echo "0";
...
case 12: // Start Inserting Credits data
		$sql = "insert into credits(ClientName, Amount, CreditDate, PublicNotes, PrivateNotes, Date) values ('".$_POST['name']."','".$_POST['amount']."','".$_POST['creditdate']."','".$_POST['publicnotes']."','".$_POST['privatenotes']."','".date("Y-m-d")."')";
		if(mysqli_query($con, $sql) or die(mysql_error())){
			echo "1";
		}else {
			echo "0";
...
case 14: // Start Inserting Quotes data
		$sql = "insert into quotes(ClientName, Email, Phone, QuoteDate, Quote, Po, ValidUntil, PartialDepo, Discount, Item, Description, UnitCost, Quantity, Currency, PrivateNotes, Terms, PublicNotes, Footer, Date) values ('".$_POST['name']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['quotedate']."','".$_POST['quote']."','".$_POST['po']."','".$_POST['validuntil']."','".$_POST['partial']."','".$_POST['discount']."','".$_POST['item']."','".$_POST['description']."','".$_POST['unitcost']."','".$_POST['quantity']."','".$_POST['currency']."','".$_POST['privatenotes']."','".$_POST['terms']."','".$_POST['publicnotes']."','".$_POST['footer']."','".date("Y-m-d")."')";
		if(mysqli_query($con, $sql) or die(mysql_error())){
			echo "1";
		}else {
			echo "0";
...
case 16: // Start Inserting Projects data
		$sql = "insert into projects(ClientName, DueDate, BudgetedHours, TaskRate, ProjectName, PrivateNotes, Date) values ('".$_POST['name']."','".$_POST['duedate']."','".$_POST['budgetedhours']."','".$_POST['taskrate']."','".$_POST['projectname']."','".$_POST['privatenotes']."','".date("Y-m-d")."')";
		if(mysqli_query($con, $sql) or die(mysql_error())){
			echo "1";
		}else {
			echo "0";
...
case 18: // Start Inserting Tasks data
		$sql = "insert into tasks(ClientName, Project, Description, Date) values ('".$_POST['name']."','".$_POST['project']."','".$_POST['description']."','".date("Y-m-d")."')";
		if(mysqli_query($con, $sql) or die(mysql_error())){
			echo "1";
		}else {
			echo "0";
...
case 22: // Start Inserting Vendors data
		$sql = "insert into vendors(VendorName, VatNumber, Email, Phone, Website, Currency, PrivateNotes, Street, AptSuit, City, StateProvince, PostalCode, Country, Date) values ('".$_POST['name']."','".$_POST['vatnumber']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['website']."','".$_POST['currency']."','".$_POST['privatenotes']."','".$_POST['street']."','".$_POST['apt']."','".$_POST['city']."','".$_POST['state']."','".$_POST['postalcode']."','".$_POST['country']."','".date("Y-m-d")."')";
		if(mysqli_query($con, $sql) or die(mysql_error())){
			echo "1";
		}else {
			echo "0";
...
case 24: // Start Inserting Proposals data
		$sql = "insert into proposals(Quote, Template, PrivateNotes, Date) values ('".$_POST['quote']."','".$_POST['template']."','".$_POST['privatenotes']."','".date("Y-m-d")."')";
		if(mysqli_query($con, $sql) or die(mysql_error())){
			echo "1";
		}else {
			echo "0";
