                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="add-reccur.php">Add Recurring Invoice</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<form id="recurringform" name="recurringform">
   ...
   <div class="form-group row">
		...
		<label class="col-sm-2 col-form-label">Auto Bill</label>
		<div class="col-sm-4">
			<select name="autobill" class="form-control">
	...
	<div class="form-group row">
		...
		<div class="col-sm-4">
			<select name="duedate" class="form-control">
				<option value="Use client terms" selected>Use client terms</option>
			<option value="1st day of month">1st day of month</option>
				<option value="2nd day of month">2nd day of month</option>
				<option value="3rd day of month">3rd day of month</option>
				<option value="4th day of month">4th day of month</option>
				<option value="5th day of month">5th day of month</option>
				<option value="6th day of month">6th day of month</option>
				<option value="7th day of month">7th day of month</option>
				<option value="8th day of month">8th day of month</option>
				<option value="9th day of month">9th day of month</option>
				<option value="10th day of month">10th day of month</option>
				<option value="11th day of month">11th day of month</option>
				<option value="12th day of month">12th day of month</option>
				<option value="13th day of month">13th day of month</option>
				<option value="14th day of month">14th day of month</option>
				<option value="15th day of month">15th day of month</option>
				<option value="16th day of month">16th day of month</option>
				<option value="17th day of month">17th day of month</option>
				<option value="18th day of month">18th day of month</option>
				<option value="19th day of month">19th day of month</option>
				<option value="20th day of month">20th day of month</option>
				<option value="21st day of month">21st day of month</option>
				<option value="22nd day of month">22nd day of month</option>
				<option value="23rd day of month">23rd day of month</option>
			    <option value="24th day of month">24th day of month</option>
			    <option value="25th day of month">25th day of month</option>
			    <option value="26th day of month">26th day of month</option>
			    <option value="27th day of month">27th day of month</option>
			    <option value="28th day of month">28th day of month</option>
			    <option value="29th day of month">29th day of month</option>
				<option value="30th day of month">30th day of month</option>
