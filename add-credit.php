                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="add-credit.php">Add Credit Details</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
			  ...
			  <div class="card">
				    ...
				    <div class="card-block">
						<form id="creditform" name="creditform">
							...
							<div class="form-group row">
								<label class="col-sm-2 col-form-label">Credit Date</label>
								<div class="col-sm-4">
								   <input name="creditdate" class="form-control" type="date" required />
								</div>
							</div>
							<div class="form-group row">
