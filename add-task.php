...
<body onload="clientnamefetch();projectnamefetch()">
<!-- [ Pre-loader ] start -->
<div class="loader-bg">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="add-task.php">Add New Task</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<!-- [ breadcrumb ] end -->
	...
	<form id="taskform" name="taskform">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<select name="name" id="select_name" onchange="taskpnamefetch()"  class="js-example-basic-single col-sm-12" required>
					<option value="" selected> </option>
				</select>
			</div>
			<label class="col-sm-2 col-form-label">Project</label>
			<div class="col-sm-4">
			  <input type="text" name="project" id="task_projectname" class="form-control" required>
			</div>
		</div>
	    <div class="form-group row">
