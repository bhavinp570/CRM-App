                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="add-vendor.php">New Vendor</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<!-- [ breadcrumb ] end -->
	...
	<form id="vendorform" name="vendorform">
	   ...
	   <div class="form-group row">
			...
			<div class="col-sm-4">
			    <textarea rows="5" cols="5" name="privatenotes" class="form-control" placeholder="" required></textarea>
			</div>
		</div>
