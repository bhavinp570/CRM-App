...
<body onload="clientnamefetch();vendornamefetch()">
<!-- [ Pre-loader ] start -->
<div class="loader-bg">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="add-expense.php">Add New Expense</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<!-- [ breadcrumb ] end -->
	...
	<form id="expenseform" name="expenseform">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<select name="vendor" id="select_vendorname" class="js-example-basic-single col-sm-12" required>
					<option value="" selected> </option>
				</select>
			</div>
			<label class="col-sm-2 col-form-label">Client</label>
			<div class="col-sm-4">
				<select name="client" id="select_name" class="js-example-basic-single col-sm-12" required>
					<option value="" selected> </option>
				</select>
			</div>
		</div>
