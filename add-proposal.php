...
<div id="pcoded" class="pcoded">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="add-proposal.php">New Proposal</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
	...
	<form id="proposalform" name="proposalform">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<select name="quote" id="select_quote" 
			onchange="quoteCnamefetch()" class="js-example-basic-single col-sm-12" required>
